        ...
        <div className={`${styles.container} ${styles.withFooter} ${darkMode ? styles.dark : styles.light}`}>
           ...
           <section className={styles.heroSection}>
                ...
                <div className={styles.colunaTexto}>
                    <h1>+Saúde</h1>
                    <p>O que a ciência descobriu recentemente?</p>
                    <p>Conheça mais sobre o assunto em nossa página +Saúde.</p>
                </div>

                <div className={styles.colunaTexto}>
                    <h1>Recursos</h1>
                    <p>Estudos atuais acerca da síndrome de burnout.</p>
                    <p>Dicas, frases motivacionais e checklists de limites saudáveis.</p>
                </div>
            </div>
            </section>

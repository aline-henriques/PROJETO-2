    ...
    <div className={`${styles.container} ${styles.withFooter} ${darkMode ? styles.dark : styles.light}`}>
      ...
      <div className={styles.funcionalidades}>
        <div className={styles.infoQuestionario}>
          ...
          <div className={styles.textInfo}>
            ...
            <p>Descubra se você possui sintomas de <strong>Burnout</strong> realizando o questionário!</p>
        ...
        <div className={styles.infoForum}>
          ...
          <div className={styles.textInfo}>
            ...
            <h2>Descobrir se a sua experiencia não é unica?</h2>
            <p>Acesse nosso fórum anônimo, compartilhe livremente suas frustrações!</p>
          </div>
        </div> 
      ...
      <footer className={styles.bottomContent}>
        <div className={styles.bottomActions}>
          ...
          <div className={styles.knowUs}> <img src={knowUsImage} alt="" />Conheça nossa iniciativa</div>
        </div>
